...
-- Records of codepage
-- ----------------------------
INSERT INTO `codepage` VALUES ('1', '福1', '福建金森公司', '2', '11', '福', '福清', '肖站', '2019-06-01 00:00:00', '2019-07-01 00:00:00', '9', '20', '0', '张三', '张敏', '王', '王', '强', '11', '111', '福3', '李四', '三水', '福清', '王博');
INSERT INTO `codepage` VALUES ('2', '福1', '福建金森公司', '2', '11', '福', '福清', '肖站', '2019-01-01 00:00:00', '2019-04-01 00:00:00', '1', '4', '4', '张三', '张敏', '王', '0', '强', '0', '0', '福3', '李四', '三水', '福清', '王博');
INSERT INTO `codepage` VALUES ('3', '福1', '福建金森公司', '2', '11', '福', '福清', '肖站', '2019-02-01 00:00:00', '2019-05-01 00:00:00', '1', '40', '0', '张三', '张敏', '王', '0', '强', '0', '0', '福3', '李四', '三水', '福清', '王博');
INSERT INTO `codepage` VALUES ('4', '福1', '福建金森公司', '2', '11', '福', '福清', '肖站', '2019-03-01 00:00:00', '2019-05-01 00:00:00', '1', '100', '1', '张三', '张敏', '王', '0', '强', '0', '0', '福3', '李四', '三水', '福清', '王博');
INSERT INTO `codepage` VALUES ('5', '江1', '福建金森公司', '999', '888', '江', '江3', '旺旺', '2019-04-01 00:00:00', '2019-06-01 00:00:00', '13', '50', '0', '朱一龙', '李丽', '吴', '吴', '霖', '6', '1', '江4', '李现', '肖站', '江7', '炎亚纶');
...
INSERT INTO `codepage` VALUES ('7', '7', '福建金森公司', '7', '7', '四', '7', '7', '2019-05-01 00:00:00', '2018-09-01 00:00:00', '7', '60', '0', '7', '7', '王', null, '强', '5', '0', '7', '7', '7', '7', '7');
INSERT INTO `codepage` VALUES ('8', '福建金农', '福建金森公司', '3', '4', '森田', '三明', '林哲', '2018-04-05 00:00:00', '2018-06-17 00:00:00', '7', '40', '0', '朱一龙', '张敏', '王', '0', '强', '0', '2', '福建金森', '李现', '肖站', '三明三水', '炎亚纶');
INSERT INTO `codepage` VALUES ('9', '那', '福建金森公司', '9', '9', '娜娜', '娜娜', '牛牛牛', '2019-09-09 00:00:00', '2019-09-30 00:00:00', '77', '200', '2', '那', '密码', '密码', '瞬时', '地点', '0', '0', '方法', 'ff', '方法', '方法', '发放');
...
-- ----------------------------
INSERT INTO `codestatus` VALUES ('4', 'again');
...
-- ----------------------------
INSERT INTO `education` VALUES ('1', '2019-12-12', '2019-12-12', '本科', '1', '123', '2019-12-12', '4');
...
-- Records of overtime
-- ----------------------------
INSERT INTO `overtime` VALUES ('18', '123', '123', '2020-12-06 03:39:00', '2021-12-06 03:40:00', '123', '加班那', '通过');
...
CREATE TABLE `tree` (
  ...
  `unitprice` double DEFAULT NULL,
  `totalnum` double DEFAULT NULL,
  PRIMARY KEY (`codeid`,`treetype`,`tlong`,`tradius`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tree` VALUES ('2', '2', '22', '2', '2', '2', '0', '0');
INSERT INTO `tree` VALUES ('2', 'za', '2', '2', '2', '2', '2', '4');
...
-- ----------------------------
-- Table structure for twotree
-- ----------------------------
DROP TABLE IF EXISTS `twotree`;
CREATE TABLE `twotree` (
  `codeid` double NOT NULL AUTO_INCREMENT,
  `endtime` datetime NOT NULL,
  `treetype` varchar(50) NOT NULL,
  `unitprice` double DEFAULT NULL,
...
-- Records of twotree
-- ----------------------------
INSERT INTO `twotree` VALUES ('1', '2019-08-01 00:00:00', '杉原木', '200', '200');
INSERT INTO `twotree` VALUES ('2', '2019-07-01 00:00:00', '杂原木', '1', '1');
INSERT INTO `twotree` VALUES ('3', '2019-04-01 00:00:00', '2', '0', '0');
INSERT INTO `twotree` VALUES ('4', '2019-04-01 00:00:00', 'za', '2', '4');
INSERT INTO `twotree` VALUES ('5', '2019-05-01 00:00:00', '杂原木', '1', '1');
INSERT INTO `twotree` VALUES ('6', '2019-05-01 00:00:00', '松原木', '1', '1');
INSERT INTO `twotree` VALUES ('7', '2019-06-01 00:00:00', '杉原木', '1', '1');
INSERT INTO `twotree` VALUES ('8', '2019-11-02 00:00:00', '杂小径', '1', '1');
INSERT INTO `twotree` VALUES ('9', '2018-09-01 00:00:00', '松小径', '1', '1');
INSERT INTO `twotree` VALUES ('10', '2019-02-01 00:00:00', '杉小径', '1', '1');
INSERT INTO `twotree` VALUES ('17', '2019-07-01 00:00:00', '杂原木', '1', '1');
INSERT INTO `twotree` VALUES ('18', '2019-04-01 00:00:00', '2', '0', '0');
INSERT INTO `twotree` VALUES ('19', '2019-04-01 00:00:00', 'za', '2', '4');
INSERT INTO `twotree` VALUES ('20', '2019-05-01 00:00:00', '杂原木', '1', '1');
INSERT INTO `twotree` VALUES ('21', '2019-05-01 00:00:00', '松原木', '1', '1');
INSERT INTO `twotree` VALUES ('22', '2019-06-01 00:00:00', '杉原木', '1', '1');
INSERT INTO `twotree` VALUES ('23', '2019-11-02 00:00:00', '杂小径', '1', '1');
INSERT INTO `twotree` VALUES ('24', '2018-09-01 00:00:00', '松小径', '1', '1');
INSERT INTO `twotree` VALUES ('25', '2019-02-01 00:00:00', '杉小径', '1', '1');
...
INSERT INTO `usermanage` VALUES ('1', 'aaa', '123456', '2020-01-03 13:59:46', '1', '管理员', '0', '0', '2020-01-03 13:59:46', '2019-12-07 00:00:00');
...
INSERT INTO `usermanage` VALUES ('2', 'bbb', '111', '2019-12-07 22:03:42', '1', '超级管理员', '0', '0', '2019-12-07 22:03:42', '2019-12-07 00:00:00');
...
INSERT INTO `usermanage` VALUES ('6', '姜钧译', '111', '2019-12-22 17:23:15', '', '超级管理员', '0', '0', '2019-12-22 17:23:14', '2019-12-07 00:00:00');
