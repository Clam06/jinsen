...
<main class="all">
    ...
    <article class="artlce">
        ...
        <div class="book_con01">
            ...
            <form  onSubmit="return inputNull(this)" action="codepageSevrlet?action=updateCodepage" method="POST">
                <div class="top">
                    <div>
                        <div class="top_out">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <input type="text" name="command" id="cccomand" value="福建金森公司" disabled="disabled" placeholder="林权单位">
                                    </td>
                                </tr>
                                <tr>
                       ...
                       <c:forEach items="${tree}" var="b">
                            <tr id='<%=i++%>' ><td style='font-size:20px;'>
                ...
                <div class=" but_p" style="float:left;"><button class="but_save" type="submit" id="mybutton" value="更新码单">更新码单</button></div>
