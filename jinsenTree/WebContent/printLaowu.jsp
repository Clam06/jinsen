    ...
    $('#query').bootstrapTable({
        ...
        [
        	...
        	},
        	{
                ...
                field: '',
                formatter:function(value,row,index){
              	   return document.getElementById("workid").value;
                 },
                title:  '劳务单号',
                align: 'center',
                valign: 'middle'
...
<body><!--  onload="my_creat()-->
    <div class="home-tab"><i class="tab-i"></i> 所在位置：<span>木材劳务结算单</span></div>
    <div class="find-top">
        <p class="p-tail"><i class="i-tail"></i> 该页面是生成木材劳务结算单，通过劳务单号和码单查询</p>
    </div>
<main class="all">
<div class="find-top1">>
<table class="top-table">
      <tr>
       <td class="top-table-label" >劳务单号：</td>
