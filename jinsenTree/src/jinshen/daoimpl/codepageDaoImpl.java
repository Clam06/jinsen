...
public class codepageDaoImpl implements codepageDao{
    ...
    {
    	String sql="select cutNum,checkNum,entrust,getPerson,year(endtime),month(endtime),day(endtime),takeIn,countid,treetype,unitprice  from codepage join tree  on codepage.codeid=tree.codeid";
	    ResultSet rs = null;
	    ...
	    try {
	        ...
	        while (rs.next()) {
    			...
    			//System.out.println("...." + rs.getDouble(2) + "...");
    			s.setStatement(rs.getDouble(9));
	        	s.setTreetype(rs.getString(10));
    ...
    public statetree printStatetree(int year)
    {
    	...
    	try {
    		...
    		while (rs.next()) {
    			...
    			d.setStatement(rs.getDouble(9));
    			//System.out.println("...." + rs.getDouble(2) + "...");
	        	d.setTreetype(rs.getString(10));
    			d.setUnitprice(rs.getDouble(11));
    			//d.add(d1);
    		}
    		return d;
    	}catch (Exception e) {
    ...
    {
    	String sql="select cutNum,checkNum,year(endtime),month(endtime),day(endtime),forperson,countid,treetype,unitprice  from codepage join tree  on codepage.codeid=tree.codeid";
	    ResultSet rs = null;
	    ...
	    try {
	        ...
	        while (rs.next()) {
    			...
    			s.setStatement(rs.getDouble(7));
	        	s.setTreetype(rs.getString(8));
    			s.setUnitprice(rs.getDouble(9));
	        	ts.add(s);
	    }
	     return ts;
      }catch (Exception e) {
    ...
    public producetree printProduce(int year)
    {
    	...
    	try {
    		...
    		while (rs.next()) {
    			...
    			d.setStatement(rs.getDouble(7));
	        	d.setTreetype(rs.getString(8));
    			d.setUnitprice(rs.getDouble(9));
    		}
    		return d;
    	}catch (Exception e) {
            e.printStackTrace();
